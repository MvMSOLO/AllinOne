...
export const TOP_10_NOSTALGIC_TRACKS: Track[] = [
  {
    ...
    albumName: 'Acoustic Rain Whispers',
  ...
  },
  {
    ...
    albumCover: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'Autumn Reflections',
    albumCover: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'River Solitude',
    albumCover: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'Whispering Leaves',
    albumCover: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'Cozy Fireplace Sessions',
    albumCover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'Rainy Night Lullabies',
    albumCover: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumCover: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'Dusk Melodies',
    albumCover: 'https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    albumName: 'Beyond the Blue',
    albumCover: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=600&auto=format&fit=crop&q=80',
...
// Real Music Search API using iTunes Search API (no API key required, worldwide CORS supported)
export const searchMusicApi = async (query: string, genrePreset?: string): Promise<Track[]> => {
  if (!query.trim() && (!genrePreset || genrePreset === 'All Genres')) return [];

  try {
    let searchTerm = query.trim();
    if (genrePreset && genrePreset !== 'All Genres') {
      searchTerm += ` ${genrePreset}`;
    }

    const encoded = encodeURIComponent(searchTerm);
    const response = await fetch(`https://itunes.apple.com/search?term=${encoded}&media=music&entity=song&limit=24`);
    ...
    return data.results
      ...
      .map((item: any, index: number) => ({
        ...
        albumName: item.collectionName || 'Single / Special Album',
    ...
    console.error('Error fetching real music from API:', err);
    return [];
  }
};
